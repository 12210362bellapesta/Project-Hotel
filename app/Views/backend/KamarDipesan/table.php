...
<!-- Page Heading -->
<h1 class="h3 mb-2 text-gray-800">Data Kamar Dipesan</h1>
<p class="mb-4">Fitur ini disediakan untuk mengelola data Kamar Dipesan sistem informasi perhotelan</p>
    ...
    $(document).ready(function(){
        ...
        $('table#table-kamardipesan').on('click', '.btn-edit', function(){
            ...
            $.get(`${baseurl}/kamardipesan/${id}`).done((e)=>{
                ...
                $('input[name=pemesananid]').val(e.pemesananid);
                $('input[name=kamarid]').val(e.kamarid);
